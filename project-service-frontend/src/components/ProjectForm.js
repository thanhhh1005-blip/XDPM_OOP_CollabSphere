    ...
    <div style={styles.page}>
      <div style={styles.container}>
          ...
          <form onSubmit={onSubmit} style={styles.form}>
            <div style={styles.field}>
              ...
              <input
                ...
                style={styles.input}
              />
              <div style={styles.hint}>Tên ngắn gọn, dễ hiểu để hiển thị trong danh sách.</div>
            </div>
            ...
            <div style={styles.field}>
              ...
              <input
                ...
                style={styles.input}
              />
              <div style={styles.hint}>Có thể để trống nếu chưa liên kết đề cương.</div>
            </div>
            ...
            <div style={styles.field}>
              ...
              />
              <div style={styles.hint}>Bạn có thể dán đề cương dài, phần danh sách sẽ chỉ hiện rút gọn.</div>
            </div>
        ...
        <div style={styles.footerNote}>
          API: <code style={styles.code}>{API_BASE_URL}</code>
        </div>
      </div>
    </div>
  );
